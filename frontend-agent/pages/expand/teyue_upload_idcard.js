// pages/expand/teyue_upload_idcard.js
...
Page({
  ...
  submit: function (e) {
    ...
    wx.request({
      url: host + 'tt_mch.php?action=teyue_apply',
      data: {
        uid: wx.getStorageSync('uid'),
        formId: formId,
        ...
        license_photo_media: shopData.license_photo_media,
        permit_photo_media: shopData.permit_photo_media,
        name: shopData.name,
        category: shopData.category,
        marketing_type:shopData.marketing_type,
