<?php
  function postUnifiedorder($subAppId, $subOpenId, $subMchId, $body, $attach, $totalFee, $profitSharing='N')
  {
  ...
  function postTenpayUnifiedorder($subAppId, $tenpayConfig, $subOpenId, $subMchId, $body, $attach, $totalFee)
  {
    ...
    $payMchKey = array(
                     ...
                     'wxpay_pay_mch_key_ext' => array(
                                                   'mini_program_sub_app_id' => $subAppId,
    ...
    $url = 'http://suishouh.applinzi.com/tenpay.php'; //本地环境curl版本不符合tenpay API接口请求要求，采用新浪云中转
    $ret = sendHttpRequest($url, $postData);
    file_put_contents('/tmp/mchsql', $ret.PHP_EOL,FILE_APPEND);
