...
Page({
  ...
  get_list:function(){
    var that = this
    wx.request({
      url: host + 'trade.php?action=get_waimai_list',
      data: {
      ...
      success: function (res) {
        ...
        for(var i=0;i<tmpData.length;i++) {
          if ('0000-00-00 00:00:00' == tmpData[i].accept_at) {
            unaccept_data[a] = tmpData[i]
            a++
          } else if  ('0000-00-00 00:00:00' == tmpData[i].delivery_at) {
