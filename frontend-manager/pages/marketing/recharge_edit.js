...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this
    wx.request({
      url: host + 'marketing.php?action=get_recharge',
      data: {
    ...
    wx.request({
      ...
      success: function (res) {
        if ('fail' == res.data) {
          ...
          wx.removeStorageSync('merchant_recharge_rule')
  ...
  delete: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: host + 'marketing.php?action=delete_recharge',
            data: {
              mch_id: wx.getStorageSync('mch_id'),
              id: id
            },
  ...
  del_coupon: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: host + 'marketing.php?action=delete_recharge_coupon',
            data: {
              mch_id: wx.getStorageSync('mch_id'),
              id: id
            },
