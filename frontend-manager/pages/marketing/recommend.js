...
Page({
  ...
  onLoad: function(options) {
    var that = this
    wx.request({
      url: host + 'marketing.php?action=get_pay_result_recommend',
      data: {
  ...
  submit: function(e) {
    ...
    wx.request({
      url: host + 'marketing.php?action=update_pay_result_recommend',
      data: {
        mch_id: wx.getStorageSync('mch_id'),
  ...
  bindCampaignTypeChange: function(e) {
    ...
    wx.request({
      url: host + 'marketing.php?action=get_pay_result_campaigns',
      data: {
        mch_id: wx.getStorageSync('mch_id'),
