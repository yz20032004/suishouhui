...
Page({
  ...
  data: {
    ...
    point_speed_range: [
      { speed: '0', title: "不返积分" },
      { speed: '1.0', title: "正常返积分" },
      { speed: '1.1', title: "1.1倍加速返积分" },
  ...
  onLoad: function (options) {
    ...
    var display = 'none'
    wx.request({
      url: host + 'mch.php?action=get_grade&id=' + id,
      data: {
  ...
  submit: function (e) {
    ...
    wx.request({
      url: host + 'mch.php?action=update_grade',
      data: {
        mch_id: wx.getStorageSync('mch_id'),
        id: id,
        grade: grade,
  ...
  delete: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: host + 'mch.php?action=delete_grade',
            data: {
              mch_id: wx.getStorageSync('mch_id'),
              id: id
            },
